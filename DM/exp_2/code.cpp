...
void minMaxNormalization()
{
    ...
    const vector<vector<string>> data = readCSV("input_MinMax.csv");
    double min_value;
    double max_value;
    ...
    writeCSV("output_MinMax.csv", normalized_data);
...
void zScoreNormalization()
{
    ...
    const vector<vector<string>> data = readCSV("input_Zscore.csv");
    ...
    // Write the normalized data to a file
    writeCSV("1output_Zscore.csv", normalized_data);
